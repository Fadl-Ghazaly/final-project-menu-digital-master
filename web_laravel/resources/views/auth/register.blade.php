    ...
    <div class="max-w-xl w-full">
        ...
        <div class="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-slate-200/60 border border-slate-100">
            ...
            <form id="registerForm" onsubmit="handleRegister(event)" class="space-y-6">
                ...
                <div id="successMessage" class="hidden p-4 bg-emerald-50 border border-emerald-100 text-emerald-700 rounded-2xl flex items-center gap-3 animate-in fade-in zoom-in duration-300">
                    <i data-lucide="check-circle" class="w-5 h-5"></i>
                    <p class="text-sm font-semibold">Akun berhasil dibuat! Cek email untuk verifikasi.</p>
                </div>
